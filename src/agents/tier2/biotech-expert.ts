...
const BiotechExtendedOutputSchema = SectorExpertOutputSchema.extend({
...
void BiotechExtendedOutputSchema;
...
## DONNEES VERIFIEES (Fact Store)

Les donnees ci-dessous ont ete extraites et verifiees a partir des documents du deal.
