    ...
    try {
      ...
      const { data } = await this.llmCompleteJSON<{
        ...
        systemPrompt: buildFallbackSystemPrompt(
          "Tu es un auditeur externe specialise en verification de donnees financieres. Tu evalues OBJECTIVEMENT la fiabilite de donnees deja extraites. Tu ne fais PAS d'extraction."
        ),
        temperature: 0.1,
