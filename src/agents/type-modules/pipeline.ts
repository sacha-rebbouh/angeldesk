...
export type AnalysisAgentResult =
  ...
  | ContradictionDetectorResult | SynthesisDealScorerResult
...
// Tier 3 agent names
export type Tier3AgentName = "contradiction-detector" | "synthesis-deal-scorer" | "devils-advocate" | "memo-generator";
