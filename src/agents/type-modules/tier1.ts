...
export interface ExitScenario { id: string; type: "acquisition_strategic" | "acquisition_pe" | "ipo" | "secondary" | "acquihire" | "failure"; name: string; description: string; probability: { level: "HIGH" | "MEDIUM" | "LOW" | "VERY_LOW"; percentage: number; rationale: string; basedOn: string }; timeline: { estimatedYears: number; range: string; milestones: string[]; assumptions: string[] }; potentialBuyers?: { name: string; type: "strategic" | "pe" | "corporate_vc"; rationale: string; recentAcquisitions?: string[]; likelihoodToBuy: "HIGH" | "MEDIUM" | "LOW" }[] }
