...
export function ThesisReviewModal(props: ThesisReviewModalProps) {
  ...
  return (
    <Dialog open={props.open} onOpenChange={() => { /* noop : non-dismissible */ }}>
      <DialogContent
        className="max-w-xl overflow-hidden p-0 sm:max-w-xl"
        showCloseButton={false}
      ...
      >
        <div className="flex max-h-[85vh] flex-col">
          ...
          <div className="min-h-0 flex-1 overflow-y-auto px-6 pb-5 pr-5">
              ...
              {mode === "menu" && (
                <div className="space-y-2">
                  <Button
                    ...
                    disabled={mode !== "menu"}
                  >
                    <Pause className="mt-0.5 h-4 w-4 shrink-0 self-start" />
                    <span>Arrêter l&apos;analyse ici — rapport thèse-only, remboursement partiel (3 cr)</span>
                  </Button>
                  <Button
                  ...
                  >
                    <Play className="mt-0.5 h-4 w-4 shrink-0 self-start" />
                    <span>
                  ...
                  >
                    <MessageSquareWarning className="mt-0.5 h-4 w-4 shrink-0 self-start" />
                    <span>Contester la reformulation (1 cr)</span>
                  </Button>
                </div>
              )}
          ...
          <DialogFooter className="shrink-0 border-t px-6 py-3 text-xs leading-relaxed text-muted-foreground sm:justify-start">
            Votre décision sera enregistrée. Sans action sous 24h, l&apos;analyse expire et les crédits sont remboursés intégralement.
          </DialogFooter>
        </div>
      </DialogContent>
    </Dialog>
