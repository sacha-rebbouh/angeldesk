...
export const YcLensSchema = z.preprocess(unwrapLensEnvelope, z.object({
  ...
  question: z.string().catch("Existe-t-il un chemin credible vers le Product-Market-Fit ?"),
  claims: z.array(
    z.object({
  ...
  summary: z.string().catch("YC lens summary unavailable"),
}));
