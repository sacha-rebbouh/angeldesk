...
// Chantier P4 — note de deal retirée de la production : overallScore / confidence / dimensionScores / scoreBreakdown / comparativeRanking OPTIONNELS (compat durable snapshots + historiques).
