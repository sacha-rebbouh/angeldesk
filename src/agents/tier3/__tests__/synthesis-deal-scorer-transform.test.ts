...
function makeMinimalLLMResponse(overrides: Record<string, unknown> = {}): unknown {
  return {
    ...
    score: {
      ...
      grade: "C",
      breakdown: [
        { criterion: "Team", weight: 0.25, score: 70, justification: "team-investigator: 70/100" },
        { criterion: "Financials", weight: 0.20, score: 60, justification: "financial-auditor: 60/100" },
        { criterion: "Market", weight: 0.15, score: 65, justification: "market-intelligence: 65/100" },
        { criterion: "GTM", weight: 0.15, score: 60, justification: "gtm-analyst: 60/100" },
        { criterion: "Product", weight: 0.15, score: 65, justification: "tech-stack-dd: 65/100" },
        { criterion: "Competitive", weight: 0.05, score: 60, justification: "competitive-intel: 60/100" },
        { criterion: "Exit", weight: 0.05, score: 60, justification: "exit-strategist: 60/100" },
      ],
    },
    redFlags: [],
    ...overrides,
