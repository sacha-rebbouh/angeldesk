...
describe('SOURCE_PRIORITY', () => {
  ...
  it('should maintain correct priority order', () => {
    ...
    expect(SOURCE_PRIORITY.FOUNDER_RESPONSE).toBeGreaterThan(SOURCE_PRIORITY.PITCH_DECK);
    expect(SOURCE_PRIORITY.PITCH_DECK).toBeGreaterThan(SOURCE_PRIORITY.CONTEXT_ENGINE);
  });
});
