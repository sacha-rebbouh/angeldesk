...
`;
  ...
  // s'auto-évaluer sur une échelle HIGH/MEDIUM/LOW — auto-confidence
  // numérique non sourcée, contraire à la doctrine. La nouvelle version
  // ancre l'audit sur la SOLIDITÉ DES PREUVES disponibles, pas sur une
  // auto-évaluation de confiance.
...
`;
  ...
  // par seuils numériques d'auto-confidence (>90% / 50-90% / <50%) — auto-
  // évaluation non sourcée. La nouvelle version catégorise par SOLIDITÉ
  // DES PREUVES (sourced / inferred / unsourced), cohérent avec le pipeline
