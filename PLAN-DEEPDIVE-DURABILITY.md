...
- **PROCHAIN = D.5d-1 (driver)** : extraction byte-inert du corps pipeline + wrapper stepwise (UNE step englobante) + inngest ON (hors step externe, passe InngestStepRunner) + golden driver. Puis d-2..k (split 1 frontière/commit), D.6, F, G.
