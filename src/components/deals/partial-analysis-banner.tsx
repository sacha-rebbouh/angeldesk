...
// Note (2026-05-29) : ce composant a été restauré post-refactor crédits-only.
// La prop legacy `subscriptionPlan` a été retirée — le déclencheur ne dépend
// plus du plan utilisateur. Reste à arbitrer son rebranchage : déclencher sur
// `isMissingTier3` (analyse incomplète détectée) ou sur `results.failed > 0`
// (agents qui ont planté). Pour l'instant, le composant n'est PAS rebranché
// dans analysis-panel.tsx.
